...
if __name__ == "__main__":
    ...
    with bz2.open("../data/enwiki-20080103.main.bz2", 'rt') as file:
        entry = {}
    ...
    pd.DataFrame(interactions, columns=['article_title', 'username']).to_csv("../data/interactions_edits.zip", compression="zip")
    print("Done")
