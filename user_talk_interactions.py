...
if __name__ == "__main__":
    ...
    with gzip.open('wiki-RfA.txt.gz', 'rt', encoding='utf-8') as f:
    ...
    with open("enwiki-20080103.user_talk", 'r') as file:
        entry = {}
    ...
    pd.DataFrame(interactions, columns=['user1', 'user2']).to_csv("interactions.csv")
    print("Done")
